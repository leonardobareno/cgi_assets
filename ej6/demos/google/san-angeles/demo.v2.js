...
var camTracks = [
	...
	{src:[ 0, 0, 8000, 0, -1200 ], dest:[ 0, 0, 0, 0, 0],     dist:0, len:2}//queda quieto
...
var movimientos = [
    ...
    {src:[ 0,0, 25, 0, 0, 0 ],                                          dest:[ POLYLEN*ANG45, -1.0*POLYLEN*(1.0 - ANG45), 25, 0, 0, 0], len:1},
    {src:[ POLYLEN*ANG45,    -1.0*POLYLEN*(1.0 - ANG45), 25, 0, 0, 0 ], dest:[ POLYLEN, -1.0*POLYLEN, 25, 0, 0, 0], len:1},
    {src:[ POLYLEN,          -1.0*POLYLEN, 25, 0, 0, 0 ],               dest:[ POLYLEN*ANG45, -1.0*(POLYLEN * (1.0+ANG45)), 25, 0, 0, 0], len:1},
    {src:[ POLYLEN*ANG45,    -1.0*(POLYLEN * (1.0+ANG45)), 25, 0, 0, 0 ], dest:[ 0, -2.0*POLYLEN, 25, 0, 0, 0], len:1},
    {src:[ 0,                -2.0*POLYLEN, 25, 0, 0, 0 ],               dest:[ -1*POLYLEN*ANG45, -1.0*(POLYLEN * (1.0+ANG45)), 25, 0, 0, 0], len:1},
    {src:[ -1*POLYLEN*ANG45, -1.0*(POLYLEN * (1.0+ANG45)), 25, 0, 0, 0 ], dest:[ -1*POLYLEN, -1.0*POLYLEN, 25, 0, 0, 0], len:1},
    {src:[ -1*POLYLEN,       -1.0*POLYLEN, 25, 0, 0, 0 ],               dest:[ -1*POLYLEN*ANG45, -1.0*POLYLEN*(1.0 - ANG45), 25, 0, 0, 0], len:1},
    {src:[ -1*POLYLEN*ANG45, -1.0*POLYLEN*(1.0 - ANG45), 25, 0, 0, 0 ], dest:[ 0, 0, 25, 0, 0, 0], len:1},
